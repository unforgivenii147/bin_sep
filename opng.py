...
"""opng.py – Opng utilities.

This module provides functionality for opng."""
...
Args:
    ...
    try:
        ...
        print("❌ Error: 'pngquant' command not found. Please ensure the 'pngquant' binary is installed and in your system PATH.")
