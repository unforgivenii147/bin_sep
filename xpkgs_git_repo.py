...
def extract_git_url(metadata: dict) -> str | None:
    ...
    """
    git_hosts = ('github.com', 'gitlab.com', 'bitbucket.org', 'sourcehut.org', 'codeberg.org')
    candidates: list[str] = []
...
def main() -> None:
    ...
    output = {'summary': {'total_packages': len(url_map), 'with_git_url': len(found), 'without_git_url': len(missing)}, 'packages': url_map}
