...
"""mkghrepo.py – Mkghrepo utilities.

This module provides functionality for mkghrepo."""
...
def load_env_file(env_path: Path | str) -> list[Path]:
    """load_env_file – load env file.

Args:
    env_path: Description of env_path."""
    env_vars = {}
    try:
...
def create_github_repo(token: Any, repo_name: str, description: Any, public: bool=True) -> Any:
