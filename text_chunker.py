...
"""text_chunker.py – Text Chunker utilities.

This module provides functionality for text chunker."""
...
Args:
    ...
    target_size: Description of target_size.
...
def main() -> None:
    """main – main."""
    parser = argparse.ArgumentParser(description='Split text files into chunks (< 5000 chars) respecting word/sentence boundaries.')
