...
"""gitfix.py – Gitfix utilities.

This module provides functionality for gitfix."""
from __future__ import annotations
import sys
from git import Repo

def sync_branch_with_upstream(repo_path: str='.') -> bool:
    """sync_branch_with_upstream – sync branch with upstream.
...
def sync_with_plumbing(repo_path: str='.') -> bool:
    """sync_with_plumbing – sync with plumbing.
