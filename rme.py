...
"""rme.py – Rme utilities.

This module provides functionality for rme."""
...
Returns:
    ...
    parser.add_argument('file', nargs='?', default='README.md', type=str, help='Path to a Markdown file (default: README.md)')
    return parser
