...
"""rename_svg_fonts.py – Rename Svg Fonts utilities.

This module provides functionality for rename svg fonts."""
...
def extract_font_id(svg_text: str) -> Any:
    """extract_font_id – extract font id.

Args:
    svg_text: Description of svg_text."""
...
def rename_svg_font(path_obj: Path) -> None:
    """rename_svg_font – rename svg font.

Args:
    path_obj: Description of path_obj."""
