...
"""bhtml.py – Bhtml utilities.

This module provides functionality for bhtml."""
...
def main() -> None:
    ...
    try:
        ...
        process = subprocess.Popen(['html-beautify'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
