...
"""sortbysize.py – Sortbysize utilities.

This module provides functionality for sortbysize."""
...
def sort_by_size(root_folder: Path) -> Any:
    """sort_by_size – sort by size.

Args:
    root_folder: Description of root_folder."""
    items = []
