...
"""split5000.py – Split5000 utilities.

This module provides functionality for split5000."""
...
def split_long_by_words(segment: str, max_chars: int=DEFAULT_MAX) -> Any:
    """split_long_by_words – split long by words.
...
def chunk_text_with_nltk(text: str, max_chars: int) -> Any:
    """chunk_text_with_nltk – chunk text with nltk.
...
def write_chunks(chunks: Any, input_path: Path, out_dir: Path, encoding: str) -> None:
    """write_chunks – write chunks.
