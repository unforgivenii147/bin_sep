...
"""sanity-check.py – Sanity Check utilities.

This module provides functionality for sanity check."""
...
def check_package_health(package_name: str) -> bool:
    """check_package_health – check package health.
