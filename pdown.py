...
"""pdown.py – Pdown utilities.

This module provides functionality for pdown."""
...
def get_package_url(package_name: str, version: Any | None=None) -> Any:
    """get_package_url – get package url.
...
def download_package(url: str, filename: Path | str, output_dir: str='.') -> Any:
...
def main() -> None:
    """main – main."""
    parser = argparse.ArgumentParser(description='Download a Python package from PyPI.org (skips Python version compatibility check)')
