...
"""autofix_typo.py – Autofix Typo utilities.

This module provides functionality for autofix typo."""
...
COMMON_SUBSTITUTIONS = {'0': 'p', '1': 'q', '2': 'w', '3': 'e', '4': 'r', '5': 't', '6': 'y', '7': 'u', '8': 'i', '9': 'o', 'a': 's', 'b': 'n', 'e': '3', 'y': '6', 'l': 'p', 'n': 'b', 's': 'a', 't': 'y', 'u': 'i', 'z': 'x'}
QWERTY_ADJACENT = {'q': 'w', 'w': 'qe', 'e': 'wr', 'r': 'et', 't': 'ry', 'y': 'tu', 'u': 'yi', 'i': 'uo', 'o': 'ip', 'p': 'o', 'a': 's', 's': 'ad', 'd': 'sf', 'f': 'dg', 'g': 'fh', 'h': 'gj', 'j': 'hk', 'k': 'jl', 'l': 'k', 'z': 'x', 'x': 'zc', 'c': 'xv', 'v': 'cb', 'b': 'vn', 'n': 'bm', 'm': 'n'}
...
Args:
    learning_db_path: Description of learning_db_path."""
    ...
    def _load_learning_db(self) -> None:
        """_load_learning_db –  load learning db."""
    ...
    def save(self) -> None:
        """save – save."""
        data = {'corrections': self.learned_corrections, 'frequencies': dict(self.error_frequency), 'context_rules': self.context_rules, 'last_updated': datetime.now().isoformat()}
    ...
    def apply_substitutions(self, word: str) -> str:
        """apply_substitutions – apply substitutions.
...
Returns:
    ...
    def learn_from_correction(self, wrong: str, correct: str) -> None:
        """learn_from_correction – learn from correction.

Args:
    wrong: Description of wrong.
...
class TypoFixerWithLearning:
    """TypoFixerWithLearning – TypoFixerWithLearning."""
...
Args:
    ...
    learning_db: Description of learning_db."""
    ...
    def _load_word_list(self) -> None:
        """_load_word_list –  load word list."""
        try:
            import nltk
...
Returns:
    bool: Description of return value."""
        ...
        for line_num, line in enumerate(lines, 1):
            ...
            def replace_word(match: Any) -> Any:
