...
"""pnr.py – Pnr utilities.

This module provides functionality for pnr."""
...
def remove_string_from_names(string_to_remove: str, dry_run: bool=False, recursive: bool=False, current_path: Path=Path.cwd()) -> int:
    """remove_string_from_names – remove string from names.

Args:
    string_to_remove: Description of string_to_remove.
...
def replace_string_in_names(str1: str, str2: str, dry_run: bool=False, recursive: bool=False, current_path: Path=Path.cwd()) -> int:
    """replace_string_in_names – replace string in names.

Args:
    str1: Description of str1.
    str2: Description of str2.
    dry_run: Description of dry_run.
    recursive: Description of recursive.
    current_path: Description of current_path.
...
def rename_by_template(template: str, dry_run: bool=False, recursive: bool=False, current_path: Path=Path.cwd()) -> int:
...
def main() -> None:
    """main – main."""
    parser = argparse.ArgumentParser(description='Rename files and directories using pathlib', formatter_class=argparse.RawDescriptionHelpFormatter, epilog='\n  Examples:\n  python pnr.py -r "old_string"\n        ')
    group = parser.add_mutually_exclusive_group(required=True)
    group.add_argument('-r', '--remove', metavar='STRING', help='Remove specified string from file and directory names')
    group.add_argument('-s', '--replace', nargs=2, metavar=('STR1', 'STR2'), help='Replace STR1 with STR2 in file and directory names')
    group.add_argument('-t', '--template', metavar='NAME', help='Rename files using template with sequential numbering')
