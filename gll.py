...
"""gll.py – Gll utilities.

This module provides functionality for gll."""
...
Returns:
    ...
    try:
        with path.open('r', encoding='utf-8', errors='replace') as infile, Path(outname).open('w', encoding='utf-8') as outfile:
