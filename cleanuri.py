...
"""cleanuri.py – Cleanuri utilities.

This module provides functionality for cleanuri."""
...
DATA_URI_PATTERN = re.compile('data:(?P<mime>[^;,]*)(?P<params>(?:;[^;,]+=[^;,]+)*?);base64,\\s*(?P<data>[A-Za-z0-9+/=]+)')
...
Args:
    ...
    processed: Description of processed."""
    try:
