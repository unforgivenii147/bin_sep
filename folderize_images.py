...
"""folderize_images.py – Folderize Images utilities.

This module provides functionality for folderize images."""
...
def iter_image_paths(root: Path) -> Iterator[Any]:
    """iter_image_paths – iter image paths.
...
Args:
    ...
    hash_func: Description of hash_func.
    hash_size: Description of hash_size.

Returns:
    HashedImage | None: Description of return value."""
    try:
...
def folderize_by_similarity(root: Path, out_dir_name: str, hash_func: str, hash_size: int, threshold: int) -> None:
    """folderize_by_similarity – folderize by similarity.

Args:
    root: Description of root.
    out_dir_name: Description of out_dir_name.
    hash_func: Description of hash_func.
    hash_size: Description of hash_size.
...
def main() -> None:
    ...
    cwd = Path.cwd()
    folderize_by_similarity(root=cwd, out_dir_name=args.out, hash_func=args.hash_func, hash_size=args.hash_size, threshold=args.threshold)
