...
"""cut30.py – Cut30 utilities.

This module provides functionality for cut30."""
...
def remove_old_commits(repo_path: str='.', days: int=30) -> None:
    """remove_old_commits – remove old commits.
...
Args:
    ...
    try:
        ...
        if earliest_commit_to_keep.parents:
            ...
            new_root = repo.git.commit_tree(earliest_commit_to_keep.tree, '-m', f'Squashed history (keeping last {days} days)')
...
def remove_commits_older_than_days(repo_path: str='.', days: int=30, auto_confirm: bool=False) -> None:
    """remove_commits_older_than_days – remove commits older than days.

Args:
    repo_path: Description of repo_path.
    days: Description of days.
    auto_confirm: Description of auto_confirm."""
    repo = Repo(repo_path)
