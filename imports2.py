...
"""imports2.py – Imports2 utilities.

This module provides functionality for imports2."""
...
class PythonImportExtractor:
    """PythonImportExtractor – PythonImportExtractor."""

    def __init__(self, pip_packages_file: str='/sdcard/data/pip.txt') -> None:
        """__init__ –   init  .

Args:
    pip_packages_file: Description of pip_packages_file."""
    ...
    def _get_stdlib_modules() -> set[str]:
        """_get_stdlib_modules –  get stdlib modules.

Returns:
    set[str]: Description of return value."""
        stdlib = set(sys.builtin_module_names)
        stdlib.update({'abc', 'aifc', 'argparse', 'array', 'ast', 'asynchat', 'asyncio', 'asyncore', 'atexit', 'audioop', 'base64', 'bdb', 'binascii', 'binhex', 'bisect', 'builtins', 'bz2', 'calendar', 'cgi', 'cgitb', 'chunk', 'cmath', 'cmd', 'code', 'codecs', 'codeop', 'collections', 'colorsys', 'compileall', 'concurrent', 'configparser', 'contextlib', 'contextvars', 'copy', 'copyreg', 'cProfile', 'crypt', 'csv', 'ctypes', 'curses', 'dataclasses', 'datetime', 'dbm', 'decimal', 'difflib', 'dis', 'distutils', 'doctest', 'dummy_thread', 'dummy_threading', 'email', 'encodings', 'ensurepip', 'enum', 'errno', 'faulthandler', 'fcntl', 'filecmp', 'fileinput', 'fnmatch', 'formatter', 'fractions', 'ftplib', 'functools', 'gc', 'getopt', 'getpass', 'gettext', 'glob', 'grp', 'gzip', 'hashlib', 'heapq', 'hmac', 'html', 'http', 'idlelib', 'imaplib', 'imghdr', 'imp', 'importlib', 'inspect', 'io', 'ipaddress', 'itertools', 'json', 'keyword', 'lib2to3', 'linecache', 'locale', 'logging', 'lzma', 'mailbox', 'mailcap', 'marshal', 'math', 'mimetypes', 'mmap', 'modulefinder', 'msilib', 'msvcrt', 'multiprocessing', 'netrc', 'nis', 'nntplib', 'numbers', 'operator', 'optparse', 'os', 'ossaudiodev', 'parser', 'pathlib', 'pdb', 'pickle', 'pickletools', 'pipes', 'pkgutil', 'platform', 'plistlib', 'poplib', 'posix', 'posixpath', 'pprint', 'profile', 'pstats', 'pty', 'pwd', 'py_compile', 'pyclbr', 'pydoc', 'queue', 'quopri', 'random', 'readline', 'reprlib', 're', 'resource', 'rlcompleter', 'runpy', 'sched', 'secrets', 'select', 'selectors', 'shelve', 'shlex', 'shutil', 'signal', 'site', 'smtpd', 'smtplib', 'sndhdr', 'socket', 'socketserver', 'spwd', 'sqlite3', 'ssl', 'stat', 'statistics', 'string', 'stringprep', 'struct', 'subprocess', 'sunau', 'symbol', 'symtable', 'sys', 'sysconfig', 'syslog', 'tabnanny', 'tarfile', 'telnetlib', 'tempfile', 'termios', 'test', 'textwrap', 'threading', 'time', 'timeit', 'tkinter', 'token', 'tokenize', 'trace', 'traceback', 'tracemalloc', 'tty', 'turtle', 'turtledemo', 'types', 'typing', 'typing_extensions', 'unicodedata', 'unittest', 'urllib', 'uu', 'uuid', 'venv', 'warnings', 'wave', 'weakref', 'webbrowser', 'winreg', 'winsound', 'wsgiref', 'xdrlib', 'xml', 'xmlrpc', 'zipapp', 'zipfile', 'zipimport', 'zlib', '__future__', '__main__', 'graphlib', 'tomllib', 'zoneinfo'})
        return stdlib
...
Args:
    pip_file: Description of pip_file.
...
Returns:
    ...
    def _extract_imports_from_ast(code: str, filename: str='<string>') -> set[str]:
        """_extract_imports_from_ast –  extract imports from ast.
...
Returns:
    ...
    def _identify_local_modules(self, directory: str='.') -> None:
        """_identify_local_modules –  identify local modules.
...
Args:
    zippath: Description of zippath.
...
Args:
    tarpath: Description of tarpath.
...
Returns:
    ...
    def extract_from_whl(self, whlpath: Path) -> set[str]:
        """extract_from_whl – extract from whl.

Args:
    whlpath: Description of whlpath.
...
Returns:
    set[str]: Description of return value."""
        ...
        elif path.suffixes[-2:] == ['.tar', '.gz'] or path.name.endswith(('.tar.xz', '.tar.zst')):
...
Returns:
    tuple[Path, set[str]]: Description of return value."""
    path, extractor = args
...
def main() -> None:
    ...
    parser.add_argument('-o', '--output', default='requirements.txt', help='Output file name (default: requirements.txt)')
    parser.add_argument('-p', '--pip-file', default='/sdcard/data/pip.txt', help='Path to pip packages file (default: /sdcard/data/pip.txt)')
