...
"""clean_wordlist.py – Clean Wordlist utilities.

This module provides functionality for clean wordlist."""
...
Returns:
    ...
    if file_size > 5 * 1024 * 1024:
        ...
        with path.open('r+b') as f, mmap.mmap(f.fileno(), 0, access=mmap.ACCESS_READ) as mm:
...
def process_wordlist(path_str: str) -> None:
    """process_wordlist – process wordlist.
...
Args:
    ...
    print(f'[Success] Updated {path_str} in-place ({len(remaining_lines)} lines remaining).')
