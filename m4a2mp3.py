...
"""m4a2mp3.py – M4A2Mp3 utilities.

This module provides functionality for m4a2mp3."""
...
def convert_m4a_to_mp3(input_file: Path | str, bitrate: str='64k') -> None:
    """convert_m4a_to_mp3 – convert m4a to mp3.

Args:
    input_file: Description of input_file.
    bitrate: Description of bitrate."""
    ...
    cmd = ['ffmpeg', '-i', input_file, '-codec:a', 'libmp3lame', '-b:a', bitrate, '-vn', '-y', output_file]
    try:
