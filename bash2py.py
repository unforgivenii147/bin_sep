...
"""bash2py.py – Bash2Py utilities.

This module provides functionality for bash2py."""
...
def extract_python_heredocs(bash_text: str) -> Any:
    """extract_python_heredocs – extract python heredocs.

Args:
    bash_text: Description of bash_text."""
    blocks = []
