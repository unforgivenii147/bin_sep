...
"""keeponeingroups.py – Keeponeingroups utilities.

This module provides functionality for keeponeingroups."""
from __future__ import annotations
import os
from pathlib import Path

def keep_one_image_per_folder(base_dir: Path | str) -> None:
    """keep_one_image_per_folder – keep one image per folder.
