...
"""vulcomment.py – Vulcomment utilities.

This module provides functionality for vulcomment."""
...
Returns:
    dict[str, set[int]]: Description of return value."""
...
def comment_lines_in_file(path: str, line_numbers: set[int]) -> tuple[list[str], list[str]]:
    """comment_lines_in_file – comment lines in file.

Args:
    path: Description of path.
    line_numbers: Description of line_numbers.
...
def show_diff_and_maybe_write(path: str, original: list[str], modified: list[str], apply: bool, backup: bool) -> None:
    """show_diff_and_maybe_write – show diff and maybe write.
...
Returns:
    ...
    ap.add_argument('--apply', default=True, action='store_true', help='Actually write changes to files. Default: dry-run (show diffs).')
