...
"""newrepo.py – Newrepo utilities.

This module provides functionality for newrepo."""
...
def run_command(cmd: Any, check: bool=True) -> Any:
...
def main() -> None:
    ...
    push_result = subprocess.run(['git', 'push', '--set-upstream', 'origin', current_branch], capture_output=True, text=True)
