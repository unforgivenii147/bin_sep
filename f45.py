...
"""f45.py – F45 utilities.

This module provides functionality for f45."""
    ...
    for paragraph in paragraphs:
        ...
        for line in lines:
            if not line.strip():
                ...
                continue
            wrapped = textwrap.fill(line, width=width, break_long_words=False, break_on_hyphens=False, replace_whitespace=False, drop_whitespace=True)
...
def main() -> None:
    ...
    parser.add_argument('-i', '--inplace', action='store_true', help='Modify the original file in-place')
    parser.add_argument('-w', '--width', type=int, default=None, help='Override target wrapping width (defaults to current terminal width)')
