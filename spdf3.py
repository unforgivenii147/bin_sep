...
"""spdf3.py – Spdf3 utilities.

This module provides functionality for spdf3."""
...
def shrink_pdf_mobile(path: Path | str) -> None:
    """shrink_pdf_mobile – shrink pdf mobile.
...
Args:
    ...
    temp_path = path + '.tmp'
    gs_args = [gs_executable, '-sDEVICE=pdfwrite', '-dCompatibilityLevel=1.4', '-dPDFSETTINGS=/screen', '-dFastWebView=true', '-dNOPAUSE', '-dQUIET', '-dBATCH', f'-sOutputFile={temp_path}', path]
    try:
