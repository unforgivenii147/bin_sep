...
"""zpkg.py – Zpkg utilities.

This module provides functionality for zpkg."""
...
def get_user_site_packages() -> Any:
    """get_user_site_packages – get user site packages."""
    import site
    return Path(site.getusersitepackages())

def check_dist_info_safely(dist_info_path: Path | str) -> bool:
    """check_dist_info_safely – check dist info safely.
...
def create_loader_stub(pkg_name: str, site_packages: Any) -> None:
    """create_loader_stub – create loader stub.
...
def process_package(pkg_name: str, site_packages: Any) -> bool:
