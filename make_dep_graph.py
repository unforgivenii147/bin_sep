...
"""make_dep_graph.py – Make Dep Graph utilities.

This module provides functionality for make dep graph."""
...
def get_installed_packages_dependencies() -> Any:
    """get_installed_packages_dependencies – get installed packages dependencies."""
    dependencies = {}
