...
"""cliner.py – Cliner utilities.

This module provides functionality for cliner."""
...
def clean_file_small(path: Path) -> tuple:
    """clean_file_small – clean file small.
...
def clean_file_large(path: Path) -> tuple:
    """clean_file_large – clean file large.
...
def clean_file_worker(path: Path) -> tuple:
    """clean_file_worker – clean file worker.
