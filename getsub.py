...
"""getsub.py – Getsub utilities.

This module provides functionality for getsub."""
...
class SubtitleDownloader:
    ...
    def search_opensubtitles(self, query: str) -> dict[str, Any]:
                ...
                if data.get('data'):
                    for item in data['data']:
                        ...
                        if attrs.get('language') == 'en':
                            return {'id': item['id'], 'title': attrs.get('title', query), 'url': attrs.get('url'), 'files': attrs.get('files', [])}
            return None
        except Exception as e:
            print(f'Error searching OpenSubtitles: {e}')
            return None

    def download_from_opensubtitles(self, sub_info: Any) -> Any | None:
        """download_from_opensubtitles – download from opensubtitles.

Args:
    sub_info: Description of sub_info."""
        try:
    ...
    def search_yify_subtitles(self, query: str) -> Any | None:
        """search_yify_subtitles – search yify subtitles.
...
Args:
    ...
    def download_srt_from_url(self, url: str) -> Any | None:
        """download_srt_from_url – download srt from url.
...
Args:
    ...
    def download_subtitles(self, query: str) -> Any:
...
Args:
    ...
    def save_subtitle(self, content: str, filename: Path | str) -> bool:
