...
"""new_repo.py – New Repo utilities.

This module provides functionality for new repo."""
...
def get_or_create_repo() -> Any:
    """get_or_create_repo – get or create repo."""
    try:
        repo = Repo(Path.cwd())
...
def stage_and_commit(repo: Any) -> None:
    """stage_and_commit – stage and commit.
...
def get_or_create_remote(repo: Any) -> Any:
    """get_or_create_remote – get or create remote.
...
def push_to_github(origin: Any) -> None:
