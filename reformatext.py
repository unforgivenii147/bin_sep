...
"""reformatext.py – Reformatext utilities.

This module provides functionality for reformatext."""
...
def restructure_text_file(path: Path) -> None:
    """restructure_text_file – restructure text file.
...
Args:
    ...
    try:
        with path.open('r', encoding='utf-8') as src, bak_path.open('w', encoding='utf-8') as dst:
            dst.write(src.read())
