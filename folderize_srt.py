...
"""folderize_srt.py – Folderize Srt utilities.

This module provides functionality for folderize srt."""
...
def _detect_batch(lines: list[str]) -> Any:
...
def detect_language_majority_vote(file_path: Path, pool: Pool) -> Any | None:
...
def organize_subtitles(directory: Path=Path.cwd()) -> None:
    """organize_subtitles – organize subtitles.
