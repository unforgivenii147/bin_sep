...
"""split_tzstd.py – Split Tzstd utilities.

This module provides functionality for split tzstd."""
...
def split_tar_zst(input_file: Path | str, num_parts: int) -> None:
    """split_tar_zst – split tar zst.

Args:
    input_file: Description of input_file.
    num_parts: Description of num_parts."""
