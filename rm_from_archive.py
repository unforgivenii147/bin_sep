...
"""rm_from_archive.py – Rm From Archive utilities.

This module provides functionality for rm from archive."""
...
def delete_from_tar_zst(archive_path: Path | str, file_to_delete: Path | str) -> None:
    """delete_from_tar_zst – delete from tar zst.

Args:
    archive_path: Description of archive_path.
    file_to_delete: Description of file_to_delete."""
