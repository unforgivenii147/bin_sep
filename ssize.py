...
"""ssize.py – Ssize utilities.

This module provides functionality for ssize."""
...
def list_and_sort_by_size(path: Path=Path()) -> Any:
    """list_and_sort_by_size – list and sort by size.
