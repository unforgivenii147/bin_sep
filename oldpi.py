...
"""oldpi.py – Oldpi utilities.

This module provides functionality for oldpi."""
...
def _has_rich_print_import(text: str) -> bool:
    """_has_rich_print_import –  has rich print import.
...
def _is_in_commented_code(text: str, line_start: int) -> bool:
    """_is_in_commented_code –  is in commented code.

Args:
    text: Description of text.
    line_start: Description of line_start.
...
def tokenizer_confirm(path: str) -> tuple[str, int] | None:
    """tokenizer_confirm – tokenizer confirm.
