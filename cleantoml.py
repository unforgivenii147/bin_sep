...
"""cleantoml.py – Cleantoml utilities.

This module provides functionality for cleantoml."""
...
def remove_toml_comments(content: str) -> str:
    """remove_toml_comments – remove toml comments.
...
def remove_line_comment(line: str) -> str:
    """remove_line_comment – remove line comment.
...
Returns:
    tuple[str, float, int, int]: Description of return value."""
...
def collect_toml_files(paths: list[Path]) -> list[Path]:
    """collect_toml_files – collect toml files.
