...
"""detect_repeated_lines.py – Detect Repeated Lines utilities.

This module provides functionality for detect repeated lines."""
...
def is_blank_line(line: str) -> bool:
    """is_blank_line – is blank line.

Args:
    line: Description of line."""
    return line.strip() == ''

def find_duplicates(path: Path, skip_blanks: bool=True) -> Any:
    """find_duplicates – find duplicates.

Args:
    path: Description of path.
    skip_blanks: Description of skip_blanks."""
    try:
...
def remove_duplicates(lines: list[str], duplicates: Any) -> Any:
...
def process_file(path: Path | str, duplicates: Any, dry_run: bool=False, auto_yes: bool=False, skip_blanks: bool=True) -> Any:
...
Args:
    ...
    auto_yes: Description of auto_yes.
    skip_blanks: Description of skip_blanks."""
    if not duplicates:
...
def main() -> None:
    """main – main."""
    parser = argparse.ArgumentParser(description='Find and remove sequential duplicate lines in Python files', epilog='Blank lines are ignored by default.')
    ...
    parser.add_argument('--include-blanks', '-b', action='store_true', help='Include blank lines when checking for duplicates (default: skip blanks)')
