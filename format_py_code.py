...
def format_python_file(path: Path) -> None:
    ...
    # Add a newline so tokenize can process one-line input reliably.
    ...
    for token in tokens:
        ...
        # A colon ends a compound statement header:
        ...
        # Prevent words/numbers from being merged together.
        if (
            not line_start
        ...
        # Add spacing around common operators.
        if token_string in {
            "=",
            "+",
            "-",
