...
"""agagc.py – Agagc utilities.

This module provides functionality for agagc."""
...
Returns:
    ...
    parser.add_argument('-c', '--create', action='store_true', help="Create remote repository on GitHub if it doesn't exist")
    parser.add_argument('-r', '--remote-name', default='origin', help='Remote name to use (default: origin)')
    return parser.parse_args()

def load_git_token() -> str | None:
    """load_git_token – load git token.
...
def create_github_repo(repo_name: str, description: str='new git repo', private: bool=False) -> Any:
    """create_github_repo – create github repo.

Args:
    repo_name: Description of repo_name.
    description: Description of description.
    private: Description of private."""
...
def setup_remote_repo(repo: Repo, token: str, remote_name: str, create_if_missing: bool) -> bool:
    """setup_remote_repo – setup remote repo.

Args:
    repo: Description of repo.
    token: Description of token.
    remote_name: Description of remote_name.
    create_if_missing: Description of create_if_missing.
