...
"""xsub.py – Xsub utilities.

This module provides functionality for xsub."""
...
def probe_subtitles(video_path: Path | str) -> Any:
    """probe_subtitles – probe subtitles.

Args:
    video_path: Description of video_path."""
    cmd = ['ffprobe', '-v', 'error', '-select_streams', 's', '-show_entries', 'stream=index,codec_name:stream_tags=language,title', '-of', 'json', video_path]
