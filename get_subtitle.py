...
"""get_subtitle.py – Get Subtitle utilities.

This module provides functionality for get subtitle."""
...
def get_english_subtitles(mkv_path: Path | str, output_dir: Path | str | None=None) -> Any:
    """get_english_subtitles – get english subtitles.

Args:
    mkv_path: Description of mkv_path.
    ...
    try:
        subtitles = download_best_subtitles([video], {language}, providers=['opensubtitles', 'podnapisi', 'addic7ed', 'tvsubtitles'])
