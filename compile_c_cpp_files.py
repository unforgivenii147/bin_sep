...
"""compile_c_cpp_files.py – Compile C Cpp Files utilities.

This module provides functionality for compile c cpp files."""
...
Args:
    ...
    try:
        ...
        if result.returncode == 0:
            return (str(path), True, f'✓ Compiled: {path.name} -> {output_path.name}')
        else:
            return (str(path), False, f'✗ Failed: {path.name}\n{result.stderr}')
