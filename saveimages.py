...
"""saveimages.py – Saveimages utilities.

This module provides functionality for saveimages."""
...
def extract_images_from_url(url: str, output_dir: Path | str) -> None:
    """extract_images_from_url – extract images from url.
