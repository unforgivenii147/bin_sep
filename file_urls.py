...
"""file_urls.py – File Urls utilities.

This module provides functionality for file urls."""
from __future__ import annotations
from pathlib import Path
from dh import BIN_EXT, TXT_EXT
EXCLUDED = {'.net', '.ai', '.org', '.com', '.me', '.svg', '.webp', '.png', '.jpg', '.jpeg', '.ico', '.cgi', '.xsl', '.bmp', '.gif'}
...
def extract_urls_to_file(output_filename: str='file_urls.txt') -> None:
    """extract_urls_to_file – extract urls to file.
