...
"""replace_translation_from_json.py – Replace Translation From Json utilities.

This module provides functionality for replace translation from json."""
...
def replace_translations(input_file: Path | str) -> None:
