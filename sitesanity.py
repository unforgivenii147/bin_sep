...
"""sitesanity.py – Sitesanity utilities.

This module provides functionality for sitesanity."""
...
def parse_arguments() -> Any:
    ...
    parser.add_argument('-i', '--ignore', action='append', default=[], help="Glob pattern or filename to ignore when checking package files (e.g., '*.md'). Can be used multiple times.")
    return parser.parse_args()

def should_ignore_file(path: Path, ignore_patterns: list[str]) -> bool:
    """should_ignore_file – should ignore file.

Args:
    path: Description of path.
    ignore_patterns: Description of ignore_patterns.
...
def check_package_files(dist: Any, ignore_patterns: list[str]) -> list[str]:
...
def check_package_dependencies(dist: Any, installed_map: dict[str, str]) -> tuple[list[str], list[str]]:
    """check_package_dependencies – check package dependencies.

Args:
    dist: Description of dist.
    installed_map: Description of installed_map.
