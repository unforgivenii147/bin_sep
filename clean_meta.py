...
"""clean_meta.py – Clean Meta utilities.

This module provides functionality for clean meta."""
...
Args:
    ...
    for line in lines:
        ...
        if stripped.startswith('[![') or stripped.lower().startswith('project-url'):
            ...
            replaced_count += 1
            continue
        if stripped.startswith(('Metadata-Version', 'Home-page', 'Author', 'Maintainer', 'License', 'Platform', 'Requires-Python', 'Description-Content-Type', 'Provides-Extra')):
            nl.append('\n')
            replaced_count += 1
            continue
