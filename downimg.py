...
"""downimg.py – Downimg utilities.

This module provides functionality for downimg."""
...
Args:
    ...
    scale_factor: Description of scale_factor."""
...
Args:
    image_paths: Description of image_paths."""
        ...
        with Pool(processes=cpu_count()) as pool:
            results = list(tqdm(pool.imap_unordered(self.downscale_image, args_list), total=len(image_paths), desc='Downscaling', unit='img', ncols=80))
        print('\n[RESULTS]')
        print('-' * 40)
