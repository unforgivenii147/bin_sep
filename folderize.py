...
"""folderize.py – Folderize utilities.

This module provides functionality for folderize."""
from __future__ import annotations
import shutil
from pathlib import Path

def get_target_folder_name(filename: str) -> str:
    """get_target_folder_name – get target folder name.
...
def cleanup_empty_dirs(root: Path) -> None:
    """cleanup_empty_dirs – cleanup empty dirs.
...
def folderize_files(root: Path=Path.cwd()) -> None:
    """folderize_files – folderize files.
