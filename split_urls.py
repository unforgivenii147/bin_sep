...
EXTENSIONS = ['htm', 'html', 'js', 'css', 'pdf', 'asp', 'aspx', 'php', 'jsp', 'jpg', 'jpeg', 'png', 'gif', 'svg', 'webp', 'zip', 'rar', '7z', 'tar', 'gz', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'txt', 'csv', 'xml', 'json', 'mp3', 'mp4', 'avi', 'mov', 'wav', 'exe', 'dmg', 'apk']
