...
"""autocomp.py – Autocomp utilities.

This module provides functionality for autocomp."""
...
ALGORITHMS = [('brotli', '.br', compress_brotli), ('zstd', '.zst', compress_zstd), ('xz', '.xz', compress_xz), ('bz2', '.bz2', compress_bz2), ('gzip', '.gz', compress_gzip), ('lz4', '.lz4', compress_lz4), ('blosc', '.blosc', compress_blosc)]
