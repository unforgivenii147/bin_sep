...
"""gclone1.py – Gclone1 utilities.

This module provides functionality for gclone1."""
...
def parse_repo_url(url_or_path: Path | str) -> Any:
    """parse_repo_url – parse repo url.

Args:
    url_or_path: Description of url_or_path."""
...
def get_repo_size_mb(user: Any, repo: Any) -> Any:
    """get_repo_size_mb – get repo size mb.
...
def clone_repo_shallow(user: Any, repo: Any) -> bool:
    """clone_repo_shallow – clone repo shallow.
