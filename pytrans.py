...
"""pytrans.py – Pytrans utilities.

This module provides functionality for pytrans."""
...
SKIP_DIRS: frozenset = frozenset({'lazy', '.git', '__pycache__', '.mypy_cache', '.ruff_cache', '.pytest_cache'})
TARGET_LANG: str = 'en'
DELAY_SECONDS: float = 0.5
MAX_WORKERS: int = 8
SHEBANG_PREFIX: str = '#!/'
KNOWN_ENGLISH_TOKENS: frozenset = frozenset({'TODO', 'FIXME', 'HACK', 'XXX', 'NOTE', 'BUG', 'pylint', 'noqa', 'type: ignore', 'pragma', 'coding:', 'encoding:', 'charset:'})
