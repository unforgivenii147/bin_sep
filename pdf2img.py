...
def convert_pdf_to_jpg(pdf_path: Path, output_folder: Path) -> bool:
    """convert_pdf_to_jpg – convert pdf to jpg.

Args:
    pdf_path: Description of pdf_path.
    output_folder: Description of output_folder.
...
Returns:
    ...
    try:
        ...
        images = convert_from_path(pdf_path=pdf_path, dpi=300, output_folder=pdf_output_dir, fmt='jpeg', thread_count=4, poppler_path=POPPLER_PATH)
        converted_files = []
...
Args:
    ...
    output_base_dir: Description of output_base_dir."""
