...
"""exsrt2.py – Exsrt2 utilities.

This module provides functionality for exsrt2."""
from __future__ import annotations
from pathlib import Path
import subprocess

def extract_subtitles(video_path: Path | str) -> None:
...
Args:
    ...
    ffprobe_cmd = ['ffprobe', '-v', 'error', '-select_streams', 's', '-show_entries', 'stream=index:stream_tags=language', '-of', 'csv=p=0', video_path]
