...
"""check_pkgs_site.py – Check Pkgs Site utilities.

This module provides functionality for check pkgs site."""
...
def get_packages_in_dir(dir_path: Path | str) -> Any:
    """get_packages_in_dir – get packages in dir.
