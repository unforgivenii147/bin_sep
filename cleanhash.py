...
"""cleanhash.py – Cleanhash utilities.

This module provides functionality for cleanhash."""
...
EXT = {'.zsh', '.fish', '.csh', '.ksh', '.yaml', '.yml', '.toml', '.ps1', '.psm1', '.awk', '.sed', '.gnuplot', '.cfg', '.conf', '.ini', '.gitignore', '.dockerignore', '.editorconfig', '.env', '.flake8', '.pylintrc'}
...
def strip_comments(line: str) -> Any:
...
def process_file(path: Path | str) -> int:
