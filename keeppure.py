...
"""keeppure.py – Keeppure utilities.

This module provides functionality for keeppure."""
...
def get_all_dist_info_dirs() -> Any:
    """get_all_dist_info_dirs – get all dist info dirs."""
    dist_info_dirs = []
    for site_dir in [*site.getsitepackages(), site.getusersitepackages()]:
        if Path(site_dir).exists():
            dist_info_dirs.extend((os.path.join(site_dir, item) for item in os.listdir(site_dir) if item.endswith('.dist-info')))
    return dist_info_dirs

def check_package_binary(dist_info_path: Path | str) -> str | None:
    """check_package_binary – check package binary.

Args:
    dist_info_path: Description of dist_info_path.
...
def get_binary_packages_parallel() -> Any:
    """get_binary_packages_parallel – get binary packages parallel."""
...
def clean_requirements_txt(requirements_file: str='requirements.txt') -> None:
    """clean_requirements_txt – clean requirements txt.

Args:
    requirements_file: Description of requirements_file."""
