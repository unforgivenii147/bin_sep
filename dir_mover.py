...
"""dir_mover.py – Dir Mover utilities.

This module provides functionality for dir mover."""
...
def get_top_level_subdirs(directory: Path) -> list[Path]:
    """get_top_level_subdirs – get top level subdirs.
