...
"""pp_pdfminer.py – Pp Pdfminer utilities.

This module provides functionality for pp pdfminer."""
...
def get_total_pages(pdf_path: Path | str) -> Any:
...
def extract_page_range(args: str) -> Any:
    """extract_page_range – extract page range.
...
def extract_pdf(pdf_path: Path | str, n_workers: int=8) -> Any:
    """extract_pdf – extract pdf.

Args:
    pdf_path: Description of pdf_path.
    n_workers: Description of n_workers."""
