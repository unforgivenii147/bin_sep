...
"""xembedded_elements2.py – Xembedded Elements2 utilities.

This module provides functionality for xembedded elements2."""
...
Args:
    ...
    file_hint: Description of file_hint.
...
def extract_base64_data(data_url: AttributeValueList | str | None, file_hint: str='asset') -> Path | None:
    """extract_base64_data – extract base64 data.
...
def download_external_url(url: AttributeValueList | str | None, file_hint: str='remote') -> Path | None:
    """download_external_url – download external url.
