...
"""rm_lines_that_contains.py – Rm Lines That Contains utilities.

This module provides functionality for rm lines that contains."""
...
def main() -> None:
    ...
    if len(filtered_args) != 2:
        print('Usage: python3 remove_lines.py <input_file> <text_to_remove> [-a|--apply]')
        print('\nOptions:')
