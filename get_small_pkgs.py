...
"""get_small_pkgs.py – Get Small Pkgs utilities.

This module provides functionality for get small pkgs."""
...
def check_pure(dist_info_path: Path | str) -> str | None:
    """check_pure – check pure.
