...
"""download_checker.py – Download Checker utilities.

This module provides functionality for download checker."""
...
def get_remote_size(url: str) -> Any:
...
def main() -> None:
    ...
    def write_function(data: str) -> None:
...
Args:
    data: Description of data."""
        ...
        sys.stdout.write(f'\r[{progress:5.1f}%] {size_str} | Speed: {fsz(speed)}/s | ETA: {eta_str}   ')
        sys.stdout.flush()
    c = pycurl.Curl()
    c.setopt(c.URL, url)
    c.setopt(c.FOLLOWLOCATION, True)
