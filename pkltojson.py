...
"""pkltojson.py – Pkltojson utilities.

This module provides functionality for pkltojson."""
...
def is_json_serializable(obj: Any) -> bool:
    """is_json_serializable – is json serializable.
...
def serialize_for_json(obj: Any) -> Any:
    """serialize_for_json – serialize for json.
