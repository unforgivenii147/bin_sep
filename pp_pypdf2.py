...
"""pp_pypdf2.py – Pp Pypdf2 utilities.

This module provides functionality for pp pypdf2."""
...
def extract_page_text(args: str) -> Any:
    """extract_page_text – extract page text.
...
def extract_pdf(pdf_path: Path | str) -> Any:
