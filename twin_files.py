...
"""twin_files.py – Twin Files utilities.

This module provides functionality for twin files."""
from __future__ import annotations
import argparse
from pathlib import Path

def remove_second_if_first_exists(root: Path, dry_run: bool=True) -> None:
    """remove_second_if_first_exists – remove second if first exists.
...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', '--apply', action='store_true', help='Actually delete files (default is dry run).')
