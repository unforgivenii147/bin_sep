...
"""pydos2unix.py – Pydos2Unix utilities.

This module provides functionality for pydos2unix."""
...
def get_input_paths(input_args: list[str] | None) -> list[Path]:
    """get_input_paths – get input paths.

Args:
    input_args: Description of input_args.
