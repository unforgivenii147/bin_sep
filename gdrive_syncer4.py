...
"""gdrive_syncer4.py – Gdrive Syncer4 utilities.

This module provides functionality for gdrive syncer4."""
...
Args:
    ...
    def is_token_expired(self) -> bool:
        """is_token_expired – is token expired.
...
Returns:
    ...
    def authenticate(self) -> None:
        ...
        token_data = {'client_id': self.client_id, 'client_secret': self.client_secret, 'code': auth_code, 'grant_type': 'authorization_code', 'redirect_uri': 'urn:ietf:wg:oauth:2.0:oob'}
