...
"""extar.py – Extar utilities.

This module provides functionality for extar."""
...
def process_archive(archive_path: Path, dry_run: bool=False, quiet: bool=False) -> Any:
...
Returns:
    ...
    parser.add_argument('--quiet', '-q', action='store_true', help='Suppress all output except errors and final summary')
