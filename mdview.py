...
"""mdview.py – Mdview utilities.

This module provides functionality for mdview."""
...
Returns:
    ...
    parser = argparse.ArgumentParser(prog='mdview', description='View a Markdown file in the terminal, page by page.')
    parser.add_argument('file', type=str, help='Path to a Markdown file')
    return parser
...
Returns:
    ...
    try:
        ...
        console.print(f'[red]Error:[/red] Permission denied: {args.file}', file=sys.stderr)
        return 1
    except UnicodeDecodeError:
        console.print(f'[red]Error:[/red] {args.file} is not a valid UTF-8 text file.', file=sys.stderr)
        return 1
