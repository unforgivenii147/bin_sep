...
"""purenotpure.py – Purenotpure utilities.

This module provides functionality for purenotpure."""
...
def is_in_system_site_packages(dist: metadata.Distribution) -> bool:
    """is_in_system_site_packages – is in system site packages.
...
def dist_has_c_extensions(dist: metadata.Distribution) -> bool:
    """dist_has_c_extensions – dist has c extensions.
