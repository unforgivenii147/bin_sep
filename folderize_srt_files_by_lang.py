...
"""folderize_srt_files_by_lang.py – Folderize Srt Files By Lang utilities.

This module provides functionality for folderize srt files by lang."""
...
def detect_language(file_path: Path) -> Any | None:
