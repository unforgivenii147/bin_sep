...
"""decryptor.py – Decryptor utilities.

This module provides functionality for decryptor."""
...
Returns:
    LiteralString: Description of return value."""
    return ''.join((random.choice(string.ascii_letters + string.digits) for _ in range(length)))

def encrypt_file(path: Path | str, key: str) -> None:
...
def decrypt_file(path: Path | str, key: str) -> None:
