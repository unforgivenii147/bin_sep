...
"""audio2txt.py – Audio2Txt utilities.

This module provides functionality for audio2txt."""
...
def m4a_to_text(input_file: Path | str, output_file: str='out.txt') -> None:
    """m4a_to_text – m4a to text.
