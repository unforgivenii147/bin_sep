...
"""gtrans.py – Gtrans utilities.

This module provides functionality for gtrans."""
...
class ResilientTranslator:
    """ResilientTranslator – ResilientTranslator."""

    def __init__(self, target_lang: str='fa') -> None:
        """__init__ –   init  .
...
Args:
    target_lang: Description of target_lang."""
        ...
        self.deep_translator = GoogleTranslator(source='en', target=target_lang) if HAS_DEEP_TRANSLATOR else None
...
def detect_language_type(line: str) -> str:
    """detect_language_type – detect language type.
