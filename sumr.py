...
"""sumr.py – Sumr utilities.

This module provides functionality for sumr."""
...
def summarize_file(input_file: Path | str, sentences_count: int=5, method: str='lexrank', language: str='english') -> Any:
    """summarize_file – summarize file.

Args:
    input_file: Description of input_file.
    sentences_count: Description of sentences_count.
