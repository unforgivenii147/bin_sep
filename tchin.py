...
"""tchin.py – Tchin utilities.

This module provides functionality for tchin."""
...
Returns:
    GoogleTranslator: Description of return value."""
    return GoogleTranslator(source='zh-CN', target='en')

def translate_text_chunked(text: str) -> str:
    """translate_text_chunked – translate text chunked.
...
def translate_python_file(content: str) -> str:
    """translate_python_file – translate python file.
...
def translate_text_file(content: str) -> str:
    """translate_text_file – translate text file.
