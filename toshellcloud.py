#!/usr/bin/env python
"""toshellcloud.py – Toshellcloud utilities.

This module provides functionality for toshellcloud."""
...
def convert_shebang(path: Path) -> tuple[str, bool, str | None]:
    """convert_shebang – convert shebang.

Args:
    path: Description of path.

Returns:
    tuple[str, bool, str | None]: Description of return value."""
    try:
        ...
        lines = content.split('\n')
        shebang = lines[0]
        termux_patterns = ['#!/data/data/com.termux/files/usr/bin/python', '#!/data/data/com.termux/files/usr/bin/python3', '#!/data/data/com.termux/files/usr/bin/env python', '#!/data/data/com.termux/files/usr/bin/env python3']
