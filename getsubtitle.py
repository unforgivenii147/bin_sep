...
"""getsubtitle.py – Getsubtitle utilities.

This module provides functionality for getsubtitle."""
...
def download_subtitles_advanced(mkv_path: Path | str, output_dir: Path | str | None=None) -> bool:
    """download_subtitles_advanced – download subtitles advanced.
