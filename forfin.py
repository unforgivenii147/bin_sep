...
"""forfin.py – Forfin utilities.

This module provides functionality for forfin."""
...
def process_file(cli_app: Any, cli_args: Any, path: Path | str) -> Any:
    """process_file – process file.

Args:
    cli_app: Description of cli_app.
    cli_args: Description of cli_args.
