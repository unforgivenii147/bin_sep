...
"""addmain.py – Addmain utilities.

This module provides functionality for addmain."""
...
def is_docstring_expr(node: ast.AST) -> bool:
    """is_docstring_expr – is docstring expr.
...
def should_wrap_node(node: ast.stmt) -> bool:
    """should_wrap_node – should wrap node.
...
Returns:
    ...
    for r in roots:
        ...
        elif r.suffix == '.py' and r.is_file():
            out.append(r)
