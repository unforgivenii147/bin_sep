...
"""boxfaces.py – Boxfaces utilities.

This module provides functionality for boxfaces."""
...
def detect_and_save_faces(input_video_path: str, output_video_path: str='out.mp4') -> None:
    """detect_and_save_faces – detect and save faces.

Args:
    input_video_path: Description of input_video_path.
    output_video_path: Description of output_video_path."""
