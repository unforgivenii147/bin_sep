...
"""check4update.py – Check4Update utilities.

This module provides functionality for check4update."""
...
def get_latest_version(pkg_info: Any) -> Any:
...
def compare_versions(pkg_version_tuple: Any) -> Any | None:
    """compare_versions – compare versions.

Args:
    pkg_version_tuple: Description of pkg_version_tuple."""
