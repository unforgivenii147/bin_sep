...
"""strep.py – Strep utilities.

This module provides functionality for strep."""
...
if __name__ == '__main__':
    ...
    with Progress(TextColumn('[bold blue]{task.description}[/]'), BarColumn(), TaskProgressColumn(), TextColumn('[bold]{task.completed}/{task.total}[/]'), console=console) as progress:
