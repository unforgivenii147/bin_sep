...
"""image2text.py – Image2Text utilities.

This module provides functionality for image2text."""
...
def process_image_cv2(image_path: Path) -> Image:
    """process_image_cv2 – process image cv2.

Args:
    image_path: Description of image_path.

Returns:
    Image: Description of return value."""
...
def process_image_skimage(image_path: Path) -> Image:
    """process_image_skimage – process image skimage.
...
def process_file2(image_path: Path | str) -> Any:
    """process_file2 – process file2.
