...
"""merge_parts.py – Merge Parts utilities.

This module provides functionality for merge parts."""
from __future__ import annotations
import argparse
import re
from concurrent.futures import ThreadPoolExecutor
from pathlib import Path
PART_RE = re.compile('^(?P<prefix>.+)\\.part(?P<num>\\d+)$')
...
Returns:
    dict[tuple[Path, str], list[tuple[int, Path]]]: Description of return value."""
