...
"""find_scripts.py – Find Scripts utilities.

This module provides functionality for find scripts."""
...
def find_scripts_without_extension(directory: Path) -> Any:
    """find_scripts_without_extension – find scripts without extension.
