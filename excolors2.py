...
"""excolors2.py – Excolors2 utilities.

This module provides functionality for excolors2."""
...
Returns:
    tuple[int, int, int, float]: Description of return value."""
...
def parse_hex_to_rgba(hex_body: str) -> Color:
    """parse_hex_to_rgba – parse hex to rgba.

Args:
    hex_body: Description of hex_body.

Returns:
    Color: Description of return value."""
    if len(hex_body) == 3:
...
def parse_rgba_match(m: re.Match) -> Color | None:
    """parse_rgba_match – parse rgba match.

Args:
    m: Description of m.

Returns:
    Color | None: Description of return value."""
    r = int(m.group('r'))
    g = int(m.group('g'))
    b = int(m.group('b'))
...
def extract_colors_from_text(text: str) -> list[Color]:
    """extract_colors_from_text – extract colors from text.

Args:
    text: Description of text.

Returns:
    list[Color]: Description of return value."""
    colors: list[Color] = []
...
Args:
    ...
    limit_bytes: Description of limit_bytes.
...
def rgb_to_luminance(r: int, g: int, b: int) -> float:
    """rgb_to_luminance – rgb to luminance.
...
def best_text_color(c: Color) -> tuple[int, int, int]:
    """best_text_color – best text color.
...
def demo_color_blocks(colors: list[Color], max_items: int=200) -> None:
    """demo_color_blocks – demo color blocks.

Args:
    colors: Description of colors.
    max_items: Description of max_items."""
