...
"""replace_symlink_with_orig.py – Replace Symlink With Orig utilities.

This module provides functionality for replace symlink with orig."""
...
def process_symlink(symlink_path: Path) -> dict[str, Any]:
    """process_symlink – process symlink.

Args:
    symlink_path: Description of symlink_path."""
    try:
