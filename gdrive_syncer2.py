...
"""gdrive_syncer2.py – Gdrive Syncer2 utilities.

This module provides functionality for gdrive syncer2."""
    ...
    Resource: Description of return value."""
        ...
        if not creds or not creds.valid:
            if creds and creds.expired and creds.refresh_token:
                ...
                flow = InstalledAppFlow.from_client_config({'installed': {'client_id': self.client_id, 'client_secret': self.client_secret, 'auth_uri': 'https://accounts.google.com/o/oauth2/auth', 'token_uri': 'https://oauth2.googleapis.com/token', 'redirect_uris': ['http://localhost']}}, SCOPES)
...
Args:
    ...
    def sync_by_folder_name(self, folder_name: Path | str, local_base_path: Path | str) -> None:
        """sync_by_folder_name – sync by folder name.
