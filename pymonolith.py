...
"""pymonolith.py – Pymonolith utilities.

This module provides functionality for pymonolith."""
...
class Monolith:
    ...
    def __init__(self, base_url: Any, timeout: int=10, headers: Any | None=None) -> None:
        """__init__ –   init  .
...
Args:
    ...
    def to_data_uri(self, content: str, mime_type: Any) -> Any:
...
Args:
    ...
    def resolve_url(self, url: str) -> Any:
...
Args:
    ...
    def guess_mime(self, url: str, fallback: str='application/octet-stream') -> Any:
...
Args:
    ...
    def process_stylesheets(self, soup: Any) -> None:
        """process_stylesheets – process stylesheets.
...
Args:
    ...
    def process_scripts(self, soup: Any) -> None:
        """process_scripts – process scripts.
...
Args:
    ...
    def process_images(self, soup: Any) -> None:
...
Args:
    ...
    def process_fonts(self, soup: Any) -> None:
        """process_fonts – process fonts.
...
Args:
    ...
    def _inline_font_urls(self, css_text: str) -> Any:
        """_inline_font_urls –  inline font urls.
...
Args:
    match: Description of match."""
        ...
        return re.sub('url\\([\\\'"]?([^\\)\\\'\\"]+)[\\\'"]?\\)', replace_url, css_text)
