...
"""clean_py.py – Clean Py utilities.

This module provides functionality for clean py."""
...
def annotate_parents(tree: Any) -> None:
    """annotate_parents – annotate parents.
...
def find_unused_symbols(source: str) -> Any:
    """find_unused_symbols – find unused symbols.
...
def remove_unused(source: str, unused: Any) -> str:
...
Args:
    ...
    nothing_to_remove = not unused['functions'] and (not unused['classes']) and (not unused['variables']) and (not unused['imports'])
