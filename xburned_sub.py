...
"""xburned_sub.py – Xburned Sub utilities.

This module provides functionality for xburned sub."""
...
def extract_frames(video_path: str, sample_fps: float=2.0, subtitle_top_ratio: float=0.75) -> list[tuple[float, np.ndarray]]:
...
def extract_burned_subs_ocr(video_path: str, output_srt_path: str, lang: str='fas', sample_fps: float=2.0, workers: int | None=None) -> None:
