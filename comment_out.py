...
"""comment_out.py – Comment Out utilities.

This module provides functionality for comment out."""
from __future__ import annotations
import os
import sys
EXTENSION_COMMENTS = {'.py': '#', '.sh': '#', '.yaml': '#', '.yml': '#', '.rb': '#', '.js': '//', '.ts': '//', '.cpp': '//', '.c': '//', '.java': '//', '.go': '//', '.html': '<!--', '.css': '/*'}
