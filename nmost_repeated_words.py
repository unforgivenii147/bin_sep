...
"""nmost_repeated_words.py – Nmost Repeated Words utilities.

This module provides functionality for nmost repeated words."""
...
def split_compound_words(text: str) -> str:
    """split_compound_words – split compound words.
...
def tokenize_with_nltk(text: str) -> list[str]:
    """tokenize_with_nltk – tokenize with nltk.
...
def tokenize_with_regex(text: str) -> list[str]:
    """tokenize_with_regex – tokenize with regex.
