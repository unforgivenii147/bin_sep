...
"""savepkgstocsv.py – Savepkgstocsv utilities.

This module provides functionality for savepkgstocsv."""
...
FIELDS = ['Package', 'Version', 'Architecture', 'Status', 'Priority', 'Section', 'Installed-Size', 'Maintainer', 'Homepage', 'Description', 'Source', 'Essential', 'Multi-Arch', 'Origin', 'Bugs']
