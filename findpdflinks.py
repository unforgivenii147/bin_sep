...
"""findpdflinks.py – Findpdflinks utilities.

This module provides functionality for findpdflinks."""
...
def crawl_for_pdfs(start_url: str, max_pages: int=100, delay: float=1.0) -> Any:
    """crawl_for_pdfs – crawl for pdfs.
        ...
        try:
            ...
            for a in soup.find_all('a', href=True):
                ...
                if full_url.lower().endswith('.pdf'):
                    ...
                    if not any((full_url.lower().endswith(ext) for ext in ('.jpg', '.jpeg', '.png', '.gif', '.css', '.js'))):
