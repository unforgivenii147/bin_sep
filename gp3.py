...
"""gp3.py – Gp3 utilities.

This module provides functionality for gp3."""
...
def ensure_git_repo() -> Repo:
    """ensure_git_repo – ensure git repo.

Returns:
    Repo: Description of return value."""
    try:
        return Repo('.')
...
def symlink_global_gitignore() -> None:
    """symlink_global_gitignore – symlink global gitignore."""
...
def get_repo_info_from_url(url: str) -> tuple[str, str] | None:
    """get_repo_info_from_url – get repo info from url.
...
def create_new_remote_repo(repo: Repo, github_token: str) -> bool:
    """create_new_remote_repo – create new remote repo.

Args:
    repo: Description of repo.
    github_token: Description of github_token.
...
def fork_and_update_remote(repo: Repo, github_token: str) -> bool:
    """fork_and_update_remote – fork and update remote.
...
def ensure_remote_repo(repo: Repo, github_token: str) -> bool:
    """ensure_remote_repo – ensure remote repo.
