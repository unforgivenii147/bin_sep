...
"""gitrepos.py – Gitrepos utilities.

This module provides functionality for gitrepos."""
from __future__ import annotations
import json
from pathlib import Path
import requests

def get_github_repos(username: str, output_file: Path | str | None=None) -> None:
    """get_github_repos – get github repos.
