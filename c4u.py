...
"""c4u.py – C4U utilities.

This module provides functionality for c4u."""
...
Returns:
    PackageInfo: Description of return value."""
        return cls(**data)
...
Args:
    state_file: Description of state_file."""
...
Args:
    pkg_info: Description of pkg_info."""
        self.state[pkg_info.pkgname] = pkg_info

    def get_pending_packages(self, all_packages: list[str]) -> list[str]:
        """get_pending_packages – get pending packages.

Args:
    all_packages: Description of all_packages.
...
Returns:
    ...
    def get_upgradable_packages(self) -> list[PackageInfo]:
        """get_upgradable_packages – get upgradable packages.

Returns:
    list[PackageInfo]: Description of return value."""
...
def query_pypi(package_name: str, installed_version: str, retries: int=2) -> PackageInfo:
    """query_pypi – query pypi.

Args:
    package_name: Description of package_name.
    installed_version: Description of installed_version.
    retries: Description of retries.

Returns:
    PackageInfo: Description of return value."""
    import requests
    url = f'https://pypi.org/pypi/{package_name}/json'
    pkg_info = PackageInfo(pkgname=package_name, installed_version=installed_version, checked_at=time.strftime('%Y-%m-%d %H:%M:%S'))
...
def _is_upgradable(installed: str, latest: str) -> bool:
    """_is_upgradable –  is upgradable.

Args:
    installed: Description of installed.
    latest: Description of latest.
