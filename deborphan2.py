...
"""deborphan2.py – Deborphan2 utilities.

This module provides functionality for deborphan2."""
...
class TermuxDeborphan:
    """TermuxDeborphan – TermuxDeborphan."""
...
Returns:
    ...
    def load_keep_list(self, filename: str | None=None) -> Any:
        """load_keep_list – load keep list.
...
Args:
    ...
    def save_keep_list(self, filename: str | None=None) -> None:
        """save_keep_list – save keep list.
...
Args:
    ...
    def add_to_keep(self, package: str) -> None:
        """add_to_keep – add to keep.

Args:
    package: Description of package."""
        self.keep_list.add(package)

    def remove_from_keep(self, package: str) -> None:
        """remove_from_keep – remove from keep.
