...
"""standalone_css.py – Standalone Css utilities.

This module provides functionality for standalone css."""
...
def get_file_extension(url: str) -> list[Path]:
...
def find_local_font(font_filename: str) -> str | None:
    """find_local_font – find local font.

Args:
    font_filename: Description of font_filename.
...
def get_local_font_base64(local_path: str) -> str | None:
    """get_local_font_base64 – get local font base64.
...
def get_remote_font_base64(url: str) -> str | None:
    """get_remote_font_base64 – get remote font base64.
...
def url_to_base64(url: str, base_css_path: Path) -> str | None:
    """url_to_base64 – url to base64.

Args:
    url: Description of url.
    base_css_path: Description of base_css_path.
...
def make_css_standalone(input_css_path: Path, output_css_path: Path) -> None:
    """make_css_standalone – make css standalone.

Args:
    input_css_path: Description of input_css_path.
    output_css_path: Description of output_css_path."""
    ...
    def replace_font_urls_in_content(match: Any) -> Any:
        """replace_font_urls_in_content – replace font urls in content.
