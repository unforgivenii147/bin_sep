...
"""trans_fa_mp.py – Trans Fa Mp utilities.

This module provides functionality for trans fa mp."""
...
def main() -> None:
    ...
    if not words:
        ...
        return
    print('Loaded %d Persian words. Starting translation with %d workers...', len(words), MAX_WORKERS)
    ...
    try:
        ...
        print('Translation dictionary saved to %s (%d entries)', output_path.name, len(results))
    except Exception as e:
