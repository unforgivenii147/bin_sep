...
"""otf_to_ttf.py – Otf To Ttf utilities.

This module provides functionality for otf to ttf."""
...
def convert_otf_to_ttf(otf_path: Path | str) -> Any:
    """convert_otf_to_ttf – convert otf to ttf.

Args:
    otf_path: Description of otf_path."""
