...
"""exurls.py – Exurls utilities.

This module provides functionality for exurls."""
...
Returns:
    Session: Description of return value."""
    session = requests.Session()
    session.headers.update({'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', 'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8', 'Accept-Language': 'en-US,en;q=0.9,fa;q=0.8', 'Accept-Encoding': 'gzip, deflate, br', 'Connection': 'keep-alive', 'Upgrade-Insecure-Requests': '1', 'Cache-Control': 'max-age=0'})
    return session

def extract_links(url: str, session: requests.Session) -> Any:
...
def split_internal_external(base_url: Any, links: Any) -> Any:
    """split_internal_external – split internal external.
...
def save_links(name: str, links: Any) -> None:
