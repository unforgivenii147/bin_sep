...
"""gext2.py – Gext2 utilities.

This module provides functionality for gext2."""
...
Args:
    ...
    name: Description of name."""
        ...
        self.entities.append({'name': name, 'full_name': full_name, 'type': entity_type, 'code': entity_code, 'path': str(self.original_path), 'is_constant': entity_type in 'constant', 'is_class': entity_type in 'class', 'is_function': entity_type in {'function', 'method'}})
