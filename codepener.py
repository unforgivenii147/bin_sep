...
"""codepener.py – Codepener utilities.

This module provides functionality for codepener."""
from __future__ import annotations
from typing import Any
import sys
from pathlib import Path

def convert_codepen_html(html_content: str, title: str='Document', charset: str='UTF-8') -> Any:
    """convert_codepen_html – convert codepen html.

Args:
    html_content: Description of html_content.
    title: Description of title.
    charset: Description of charset."""
    full_html = f'<!DOCTYPE html>\n<html lang="en">\n<head>\n    <meta charset="{charset}">\n    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n    <title>{title}</title>\n    <link rel="stylesheet" href="style.css">\n</head>\n<body>\n{html_content}\n    <script src="script.js"></script>\n</body>\n</html>\n'
    return full_html

def process_file(input_file: Path | str, output_file: Path | str | None=None, title: str | None=None) -> bool:
