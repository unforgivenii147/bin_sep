...
"""mkdebs.py – Mkdebs utilities.

This module provides functionality for mkdebs."""
...
Returns:
    ...
    try:
        ...
        maintainer = 'Unknown Maintainer'
    return {'Package': pkg_name, 'Version': version, 'Architecture': architecture, 'Maintainer': maintainer, 'Description': description.replace('\n', ' ').strip()}

def create_control_file(path: Path, meta: dict[str, str]) -> None:
    """create_control_file – create control file.
...
Args:
    ...
    output_deb: Description of output_deb."""
