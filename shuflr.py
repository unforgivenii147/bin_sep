...
"""shuflr.py – Shuflr utilities.

This module provides functionality for shuflr."""
...
def enhanced_shuffle(input_file: Path | str, output_file_prefix: Path | str | None=None, methods: Any | None=None, repeats: int=3) -> None:
    """enhanced_shuffle – enhanced shuffle.

Args:
    input_file: Description of input_file.
    output_file_prefix: Description of output_file_prefix.
    methods: Description of methods.
    repeats: Description of repeats."""
    if methods is None:
...
def crypto_shuffle(lst: Any) -> None:
...
def test_randomness(input_file: Path | str) -> None:
    """test_randomness – test randomness.
...
def main() -> None:
    ...
    parser.add_argument('-o', '--output', help='Output file prefix (default: will append method name to input file name)')
