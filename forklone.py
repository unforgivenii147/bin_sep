...
"""forklone.py – Forklone utilities.

This module provides functionality for forklone."""
...
def load_env_token() -> Any:
    """load_env_token – load env token."""
...
def get_github_client() -> Any:
    """get_github_client – get github client."""
...
def fork_repository(g: Any, user: Any, repo_full: Any) -> Any:
    """fork_repository – fork repository.

Args:
    g: Description of g.
    user: Description of user.
    repo_full: Description of repo_full."""
    try:
...
def clone_and_setup(forked_repo: Any, original_full_name: str) -> Any:
    """clone_and_setup – clone and setup.

Args:
    forked_repo: Description of forked_repo.
    original_full_name: Description of original_full_name."""
...
def create_env_template() -> bool:
    """create_env_template – create env template."""
    env_path = Path.home() / '.env'
