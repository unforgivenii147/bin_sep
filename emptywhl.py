...
"""emptywhl.py – Emptywhl utilities.

This module provides functionality for emptywhl."""
...
Returns:
    ...
    try:
        with zipfile.ZipFile(wheel_path, 'r') as z:
            [name.rstrip('/') for name in z.namelist() if name.endswith('.dist-info/') or (name == name.rstrip('/') + '/' and name.endswith('.dist-info'))]
