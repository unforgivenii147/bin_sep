...
"""ewhl.py – Ewhl utilities.

This module provides functionality for ewhl."""
...
def move_empty_wheels(source_dir: Path | str, dest_dir_name: str='empty_wheels') -> None:
    """move_empty_wheels – move empty wheels.
...
def main() -> None:
    """main – main."""
    parser = argparse.ArgumentParser(description='Move empty .whl files (only dist-info, no Python code) to a subdirectory')
