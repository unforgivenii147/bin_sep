...
"""delcomit.py – Delcomit utilities.

This module provides functionality for delcomit."""
...
def delete_commits_older_than_week(repo_path: str='.', branch: str='master') -> bool:
    """delete_commits_older_than_week – delete commits older than week.
...
def delete_commits_interactive(repo_path: str='.', branch: str='master', days_old: int=7) -> bool:
    """delete_commits_interactive – delete commits interactive.

Args:
    repo_path: Description of repo_path.
    branch: Description of branch.
    days_old: Description of days_old.
...
def delete_commits_with_rebase(repo_path: str='.', branch: str='master', days_old: int=7) -> bool | None:
    """delete_commits_with_rebase – delete commits with rebase.
