...
"""speller.py – Speller utilities.

This module provides functionality for speller."""
...
def process_file(path: str, autofix: bool=False, num_processes: int | None=None) -> None:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Detect and optionally autofix misspelled words in a file using parallel processing.')
