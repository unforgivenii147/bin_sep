...
This module provides functionality for pd."""
...
def is_pure_python(requires_python: Any) -> bool:
    """is_pure_python – is pure python.

Args:
    requires_python: Description of requires_python."""
    return requires_python is None or all((tag.interpreter == 'py' and tag.abi == 'none' and (tag.platform == 'any') for tag in tags.sys_tags()))

def get_package_urls(pkg_name: str) -> Any:
    """get_package_urls – get package urls.
...
def download_package(pkg_name: str) -> None:
