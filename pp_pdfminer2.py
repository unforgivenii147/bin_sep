...
"""pp_pdfminer2.py – Pp Pdfminer2 utilities.

This module provides functionality for pp pdfminer2."""
...
def float_or_disabled(x: str) -> float | None:
    """float_or_disabled – float or disabled.
...
def extract_text_from_page(page: Any, laparams: LAParams | None=None) -> str:
    """extract_text_from_page – extract text from page.

Args:
    page: Description of page.
    laparams: Description of laparams.
...
def extract_text(files: Iterable[str]=[], outfile: str='-', laparams: LAParams | None=None, output_type: str='text', codec: str='utf-8', strip_control: bool=False, maxpages: int=0, page_numbers: Container[int] | None=None, password: str='', scale: float=1.0, rotation: int=0, layoutmode: str='normal', output_dir: str | None=None, debug: bool=False, disable_caching: bool=False, **kwargs: Any) -> None:
    """extract_text – extract text.

Args:
    files: Description of files.
    outfile: Description of outfile.
    laparams: Description of laparams.
    output_type: Description of output_type.
    codec: Description of codec.
    strip_control: Description of strip_control.
    maxpages: Description of maxpages.
    page_numbers: Description of page_numbers.
    password: Description of password.
    scale: Description of scale.
    rotation: Description of rotation.
    layoutmode: Description of layoutmode.
    ...
    **kwargs: Description of **kwargs."""
    ...
    for fname in files:
        ...
        page_num = 0
        for page_idx, page_layout in enumerate(pdfminer.high_level.extract_pages(fname, laparams=laparams, maxpages=maxpages, page_numbers=page_numbers, password=password, caching=not disable_caching)):
...
Returns:
    ...
    output_params.add_argument('--strip-control', '-S', default=False, action='store_true', help='Remove control statement from text.')
    return parser
