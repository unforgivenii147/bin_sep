...
"""resizeimg.py – Resizeimg utilities.

This module provides functionality for resizeimg."""
from __future__ import annotations
from pathlib import Path
import glob
from PIL import Image

def reduce_image_size(image_path: Path | str, scale_factor: float=0.75) -> None:
