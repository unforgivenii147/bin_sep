...
"""foldext.py – Foldext utilities.

This module provides functionality for foldext."""
...
def folderize_by_extension(cwd: Path) -> Any:
    """folderize_by_extension – folderize by extension.
