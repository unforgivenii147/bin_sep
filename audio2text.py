...
"""audio2text.py – Audio2Text utilities.

This module provides functionality for audio2text."""
...
def wav_to_text_chunked(input_file: Path | str, output_file: str='out.txt', chunk_duration_ms: int=30000) -> None:
    """wav_to_text_chunked – wav to text chunked.

Args:
    input_file: Description of input_file.
    output_file: Description of output_file.
    chunk_duration_ms: Description of chunk_duration_ms."""
                ...
                try:
                    ...
                    if text.strip():
                        ...
                        with open(output_file, 'a', encoding='utf-8') as f:
                            f.write(text + ' ')
                        print(f'  ✓ Chunk {i + 1} transcribed: {text[:100]}...' if len(text) > 100 else f'  ✓ Chunk {i + 1} transcribed: {text}')
                    else:
