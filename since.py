...
"""since.py – Since utilities.

This module provides functionality for since."""
...
class PersianDateConverter:
    """PersianDateConverter – PersianDateConverter."""
    ...
    def is_persian_leap_year(year: int) -> bool:
        """is_persian_leap_year – is persian leap year.
...
Args:
    ...
    @staticmethod
    def persian_to_gregorian(persian_year: Any, persian_month: Any, persian_day: Any) -> Any:
        """persian_to_gregorian – persian to gregorian.

Args:
    persian_year: Description of persian_year.
    persian_month: Description of persian_month.
    persian_day: Description of persian_day."""
    ...
    @staticmethod
    def days_since(gregorian_year: Any, gregorian_month: Any, gregorian_day: Any) -> Any:
        """days_since – days since.

Args:
    gregorian_year: Description of gregorian_year.
    gregorian_month: Description of gregorian_month.
    gregorian_day: Description of gregorian_day."""
    ...
    @staticmethod
    def format_days_since(days: Any) -> Any:
        """format_days_since – format days since.

Args:
    days: Description of days."""
        if days < 0:
    ...
    @staticmethod
    def format_persian_date(year: int, month: int, day: int) -> Any:
        """format_persian_date – format persian date.
